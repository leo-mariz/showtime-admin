  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Banir Conjunto</DialogTitle>
          <DialogDescription>
            Banir permanentemente o conjunto {groupName}. Esta ação impedirá o acesso do conjunto à plataforma.
          </DialogDescription>
        </DialogHeader>
